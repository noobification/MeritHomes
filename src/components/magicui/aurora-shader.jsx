...
void main(){
  ...
  // Do not premultiply the raw color by intensity here, 
  // otherwise the premultiplied alpha step below applies it twice, 
  // causing dirty dark gray fringing on light backgrounds.
...
export function AuroraShader({
    ...
    useEffect(() => {
        ...
        // Explicitly delete uv attribute if it exists, as done in Lightswind
    ...
    }, [amplitude, blend, JSON.stringify(colorStops), speed]);
