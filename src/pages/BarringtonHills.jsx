...
function BarringtonHills() {
    const faqSchemas = [
        {
            "@type": "Question",
            "name": "Does Merit Homes build in Barrington Hills?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, we specialize in grand acreage estates and equestrian-ready manors throughout Barrington Hills."
            }
        },
        {
            "@type": "Question",
            "name": "What sets your Barrington Hills projects apart?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "We specialize in grand scale, crafting expansive modern retreats and traditional manors that take full advantage of Barrington Hills' prestigious acreage."
            }
        }
    ];
    ...
    return (
        <LocationLayout
            title="Grand Acreage Estates in Barrington Hills, IL"
            description="Scaling your vision to the expansive horizons of Barrington Hills? Merit Homes specializes in grand acreage estates and sprawling modern retreats."
            locality="Barrington Hills, IL"
                    ...
                    <div ref={contentRef} className="container mx-auto px-6 z-10 relative grid grid-cols-1 lg:grid-cols-12 gap-12 items-center lg:items-end">
                        ...
                        >
                            ...
                            <h1 className="text-4xl md:text-6xl lg:text-[5.5rem] font-display text-white mb-2 leading-[1.1]">
                                Sprawling Bespoke <br />
                                <span className="text-accent-gold italic font-light">Luxury Estates</span> <br />
                        ...
                        >
                            <div className="pl-0 lg:pl-8 border-l-0 lg:border-l border-white/10 relative flex flex-col items-center lg:items-start text-center lg:text-left">
                                ...
                                <p className="text-lg md:text-xl text-white/70 leading-relaxed font-light mb-8 max-w-xl mx-auto lg:mx-0">
                                    Seeking absolute architectural grandeur in Barrington Hills? Merit Homes crafts expansive custom estates that redefine privacy and scale. From equestrian-friendly designs to private modern monuments, we can realize your vision on the area's massive lots.
                                </p>
...
export default BarringtonHills;
