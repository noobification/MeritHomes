...
function BurrRidge() {
    const faqSchemas = [
        {
            "@type": "Question",
            "name": "Does Merit Homes build in Burr Ridge?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, we specialize in luxury custom estate construction throughout Burr Ridge, focusing on grand architectural designs and premium lot developments."
            }
        },
        {
            "@type": "Question",
            "name": "What is the typical square footage for a Burr Ridge estate?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Our Burr Ridge projects typically range from 5,000 to 12,000+ square feet, depending on the client's vision and lot size."
            }
        }
    ];
    ...
    return (
        <LocationLayout
            title="Custom Estate Construction in Burr Ridge, IL"
            description="Envisioning a grand estate in the village of trees? Merit Homes can craft sprawling architectural masterpieces that honor the legacy of Burr Ridge."
            locality="Burr Ridge, IL"
                        ...
                        >
                            <div className="pl-0 lg:pl-8 border-l-0 lg:border-l border-white/10 relative flex flex-col items-center lg:items-start text-center lg:text-left">
                                ...
                                <p className="text-lg md:text-xl text-white/70 leading-relaxed font-light mb-8 max-w-xl mx-auto lg:mx-0">
                                    Envisioning a grand estate in the village of trees? Merit Homes can craft sprawling architectural masterpieces that honor the legacy of Burr Ridge. From gated private drives to expansive modern manors, we can realize your vision.
                                </p>
