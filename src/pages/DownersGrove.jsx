...
function DownersGrove() {
    const faqSchemas = [
        {
            "@type": "Question",
            "name": "How does Merit Homes handle luxury infill in Downers Grove?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "We specialize in identifying and developing high-potential infill lots in Downers Grove, focusing on luxury subdivisions like Denburn Woods and prestigious village center rebuilds."
            }
        },
        {
            "@type": "Question",
            "name": "What is the custom build process for Downers Grove?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Our process involves navigating Downers Grove's building codes and community standards to deliver modern architectural masterpieces that enhance the local landscape."
            }
        }
    ];
    ...
    return (
        <LocationLayout
            title="Strategic Infill Custom Homes in Downers Grove, IL"
            description="Discover modern luxury in Downers Grove. Merit Homes crafts strategic infill masterpieces and high-growth luxury residences tailored to your vision."
            locality="Downers Grove, IL"
                    ...
                    <div ref={contentRef} className="container mx-auto px-6 z-10 relative grid grid-cols-1 lg:grid-cols-12 gap-12 items-center lg:items-end">
                        ...
                        >
                            ...
                            <h1 className="text-4xl md:text-6xl lg:text-[5.5rem] font-display text-white mb-2 leading-[1.1]">
                                Bespoke Design <br />
                                <span className="text-accent-gold italic font-light">Modern Infill</span> <br />
                                in Downers Grove
                            </h1>
                        </motion.div>
                        ...
                        >
                            <div className="pl-0 lg:pl-8 border-l-0 lg:border-l border-white/10 relative flex flex-col items-center lg:items-start text-center lg:text-left">
                                ...
                                <p className="text-lg md:text-xl text-white/70 leading-relaxed font-light mb-8 max-w-xl mx-auto lg:mx-0">
                                    Seeking bespoke architectural detail on a prime Downers Grove lot? Merit Homes specializes in high-spec modern infill projects that maximize lifestyle potential while honoring the village's unique character. We build the future.
                                </p>
                                <div
