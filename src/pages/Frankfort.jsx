...
function Frankfort() {
    const faqSchemas = [
        {
            "@type": "Question",
            "name": "Why is Frankfort a prime location for custom home builds?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Frankfort offers a unique combination of expansive estate lots, high-ceiling building opportunities, and a strong demand for new-money custom architecture."
            }
        },
        {
            "@type": "Question",
            "name": "How does Merit Homes approach construction in Frankfort?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "We focus on large-scale architectural statements that maximize acreage potential, blending modern opulence with the village's historic charm."
            }
        }
    ];
    ...
    return (
        <LocationLayout
            title="Southwest Growth Custom Homes in Frankfort, IL"
            description="Build your dream estate in Frankfort. Merit Homes crafts sprawling architectural masterpieces that define modern luxury across the village's growth corridor."
            locality="Frankfort, IL"
                        ...
                        >
                            <div className="pl-0 lg:pl-8 border-l-0 lg:border-l border-white/10 relative flex flex-col items-center lg:items-start text-center lg:text-left">
                                ...
                                <p className="text-lg md:text-xl text-white/70 leading-relaxed font-light mb-8 max-w-xl mx-auto lg:mx-0">
                                    Seeking a sprawling custom estate in Frankfort's growth corridor? Merit Homes specializes in architectural masterpieces that maximize high-ceiling volume and land potential. We build for the future of the Southwest suburbs.
                                </p>
                                <div
