...
function GlenEllyn() {
    const faqSchemas = [
        {
            "@type": "Question",
            "name": "How does Merit Homes utilize Glen Ellyn's unique topography?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Our designs leverage Glen Ellyn's signature elevation changes and wooded lots to create multi-level architectural masterpieces with dramatic curb appeal."
            }
        },
        {
            "@type": "Question",
            "name": "What is the focus of custom building in Glen Ellyn?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "We focus on boutique luxury and personalized architectural detail that complements the charm and prestige of this historic Hill Village."
            }
        }
    ];
    ...
    return (
        <LocationLayout
            title="Boutique Luxury Custom Homes in Glen Ellyn, IL"
            description="Elevate your architectural vision in Glen Ellyn. Merit Homes crafts boutique luxury residences that blend with the hills and charm of the village."
            locality="Glen Ellyn, IL"
                        ...
                        >
                            <div className="pl-0 lg:pl-8 border-l-0 lg:border-l border-white/10 relative flex flex-col items-center lg:items-start text-center lg:text-left">
                                ...
                                <p className="text-lg md:text-xl text-white/70 leading-relaxed font-light mb-8 max-w-xl mx-auto lg:mx-0">
                                    Seeking boutique architectural detail in the heart of Glen Ellyn? Merit Homes designs premium custom rebuilds that perfectly balance modern luxury with the established village charm. We can realize your vision on any lot.
                                </p>
                                <div
