...
function Hinsdale() {
    const faqSchemas = [
        {
            "@type": "Question",
            "name": "Does Merit Homes build in Hinsdale?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, Merit Homes specializes in premium new construction and luxury teardown rebuilds throughout Hinsdale."
            }
        },
        {
            "@type": "Question",
            "name": "What architectural styles do you build in Hinsdale?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "From timeless traditional estates to progressive modern designs, we craft homes that respect Hinsdale's historic character while providing state-of-the-art luxury."
            }
        }
    ];
    ...
    return (
        <LocationLayout
            title="Bespoke Luxury Rebuilds in Hinsdale, IL"
            description="Ready to transform a classic Hinsdale lot into a modern legacy? Merit Homes specializes in premium new construction that blends seamlessly with the village's historic prestige."
            locality="Hinsdale, IL"
                        ...
                        >
                            <div className="pl-0 lg:pl-8 border-l-0 lg:border-l border-white/10 relative flex flex-col items-center lg:items-start text-center lg:text-left">
                                ...
                                <p className="text-lg md:text-xl text-white/70 leading-relaxed font-light mb-8 max-w-xl mx-auto lg:mx-0">
                                    Envisioning a modern masterpiece in the heart of Hinsdale? Merit Homes specializes in high-spec luxury rebuilds that honor the architectural pedigree of the village. From compact village lots to sprawling estates, we can realize your vision.
                                </p>
