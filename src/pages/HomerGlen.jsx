...
function HomerGlen() {
    const faqSchemas = [
        {
            "@type": "Question",
            "name": "Does Merit Homes build in Homer Glen?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, we are luxury custom estate builders in Homer Glen, specializing in large-acreage architectural masterpieces."
            }
        },
        {
            "@type": "Question",
            "name": "Can you build on open acreage in Homer Glen?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Absolutely. We specialize in taking full advantage of Homer Glen's rolling acreage to create sprawling custom estates."
            }
        }
    ];
    ...
    return (
        <LocationLayout
            title="Luxury Custom Estates in Homer Glen, IL"
            description="Dreaming of wide-open spaces and architectural grandeur in Homer Glen? Merit Homes can craft sprawling custom estates that take full advantage of the area's rolling acreage."
            locality="Homer Glen, IL"
                    ...
                    <div ref={contentRef} className="container mx-auto px-6 z-10 relative grid grid-cols-1 lg:grid-cols-12 gap-12 items-center lg:items-end">
                        ...
                        >
                            ...
                            <h1 className="text-4xl md:text-6xl lg:text-[5.5rem] font-display text-white mb-2 leading-[1.1]">
                                Expansive Estate <br />
                                <span className="text-accent-gold italic font-light">Custom Builds</span> <br />
                                in Homer Glen, IL
                            </h1>
                        </motion.div>
                        ...
                        >
                            <div className="pl-0 lg:pl-8 border-l-0 lg:border-l border-white/10 relative flex flex-col items-center lg:items-start text-center lg:text-left">
                                ...
                                <p className="text-lg md:text-xl text-white/70 leading-relaxed font-light mb-8 max-w-xl mx-auto lg:mx-0">
                                    Envisioning a sprawling estate in Homer Glen? Merit Homes specializes in architectural masterpieces that maximize high-ceiling volume and land potential. From massive custom lots to community-driven luxury, we can realize your vision.
                                </p>
