...
function LakeForest() {
    const faqSchemas = [
        {
            "@type": "Question",
            "name": "Does Merit Homes build in historic Lake Forest districts?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, we specialize in luxury custom homes that respect the historic architectural integrity of Lake Forest while providing modern high-ceiling luxury."
            }
        },
        {
            "@type": "Question",
            "name": "Can you help find estate lots in Lake Forest?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "We work closely with local experts to identify prime estate lots and teardown opportunities that can accommodate expansive custom residences."
            }
        }
    ];
    ...
    return (
        <LocationLayout
            title="Legacy Prestige Custom Homes in Lake Forest, IL"
            description="Experience architectural excellence in Lake Forest with Merit Homes. We craft expansive North Shore estates and historic-inspired luxury residences."
            locality="Lake Forest, IL"
                        ...
                        >
                            <div className="pl-0 lg:pl-8 border-l-0 lg:border-l border-white/10 relative flex flex-col items-center lg:items-start text-center lg:text-left">
                                ...
                                <p className="text-lg md:text-xl text-white/70 leading-relaxed font-light mb-8 max-w-xl mx-auto lg:mx-0">
                                    Seeking to anchor your family heritage in Lake Forest? Merit Homes crafts architectural statements that honor the North Shore's historic pedigree. We specialize in expansive estate builds that merge timeless design with modern luxury.
                                </p>
                                <div
