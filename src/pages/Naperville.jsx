...
function Naperville() {
    const faqSchemas = [
        {
            "@type": "Question",
            "name": "Does Merit Homes build in Naperville?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, we are premium custom home builders in Naperville, bringing world-class architectural design to the area's premier subdivisions."
            }
        },
        {
            "@type": "Question",
            "name": "What is the custom home build process in Naperville?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Our process involves comprehensive site analysis, architectural design that honors local standards, and master craftsmanship across all phases of construction."
            }
        }
    ];
    ...
    return (
        <LocationLayout
            title="Premium Custom Home Builders in Naperville, IL"
            description="Looking to elevate your lifestyle in Naperville? Merit Homes brings world-class architectural design and master craftsmanship to the city's premier subdivisions."
            locality="Naperville, IL"
                    ...
                    <div ref={contentRef} className="container mx-auto px-6 z-10 relative grid grid-cols-1 lg:grid-cols-12 gap-12 items-center lg:items-end">
                        ...
                        >
                            ...
                            <h1 className="text-4xl md:text-6xl lg:text-[5.5rem] font-display text-white mb-2 leading-[1.1]">
                                High-Volume <br />
                                <span className="text-accent-gold italic font-light">Luxury Builds</span> <br />
                                in Naperville, IL
                            </h1>
                        </motion.div>
                        ...
                        >
                            <div className="pl-0 lg:pl-8 border-l-0 lg:border-l border-white/10 relative flex flex-col items-center lg:items-start text-center lg:text-left">
                                ...
                                <p className="text-lg md:text-xl text-white/70 leading-relaxed font-light mb-8 max-w-xl mx-auto lg:mx-0">
                                    Ready for a high-volume luxury build in Naperville? Merit Homes specializes in craft-driven construction that balances modern amenities with suburban scale. From downtown teardowns to custom estate lots, we can realize your vision.
                                </p>
