...
function StCharles() {
    const faqSchemas = [
        {
            "@type": "Question",
            "name": "Does Merit Homes build riverfront properties in St. Charles?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, we specialize in luxury custom residences that leverage the unique topography and views of St. Charles' prestigious riverfront lots."
            }
        },
        {
            "@type": "Question",
            "name": "What is the focus of custom building in St. Charles?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "We focus on expansive estate designs and modern luxury rebuilds that honor the unique beauty and high-ceiling potential of the Fox River Valley."
            }
        }
    ];
    ...
    return (
        <LocationLayout
            title="Riverfront Luxury Custom Homes in St. Charles, IL"
            description="Experience architectural excellence in St. Charles. Merit Homes crafts prestigious riverfront residences and expansive estates in the Fox River Valley."
            locality="St. Charles, IL"
                        ...
                        >
                            <div className="pl-0 lg:pl-8 border-l-0 lg:border-l border-white/10 relative flex flex-col items-center lg:items-start text-center lg:text-left">
                                ...
                                <p className="text-lg md:text-xl text-white/70 leading-relaxed font-light mb-8 max-w-xl mx-auto lg:mx-0">
                                    Ready to build your riverfront legacy in St. Charles? Merit Homes crafts architectural statements that merge Fox River beauty with modern high-ceiling luxury. We specialize in expansive estates that define the gold standard.
                                </p>
                                <div
