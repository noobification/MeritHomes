...
function Winnetka() {
    const faqSchemas = [
        {
            "@type": "Question",
            "name": "Does Merit Homes build lakefront residences in Winnetka?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, we are equipped to design and build ultra-luxury residences on Winnetka's prestigious lakefront, focusing on panoramic views and elite craftsmanship."
            }
        },
        {
            "@type": "Question",
            "name": "What architectural styles do you specialize in for Winnetka?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "From modern minimalist masterpieces to classic European-inspired estates, we tailor every build to the client's vision and Winnetka's high standards."
            }
        }
    ];
    ...
    return (
        <LocationLayout
            title="Ultra-Elite Custom Home Building in Winnetka, IL"
            description="Redefine modern opulence in Winnetka. Merit Homes specializes in ultra-elite custom residences and prestigious lakefront builds."
            locality="Winnetka, IL"
                    ...
                    <div ref={contentRef} className="container mx-auto px-6 z-10 relative grid grid-cols-1 lg:grid-cols-12 gap-12 items-center lg:items-end">
                        ...
                        >
                            ...
                            <h1 className="text-4xl md:text-6xl lg:text-[5.5rem] font-display text-white mb-2 leading-[1.1]">
                                Modern Opulence <br />
                                <span className="text-accent-gold italic font-light">Ultra-Luxury</span> <br />
                                in Winnetka
                            </h1>
                        </motion.div>
                        ...
                        >
                            <div className="pl-0 lg:pl-8 border-l-0 lg:border-l border-white/10 relative flex flex-col items-center lg:items-start text-center lg:text-left">
                                ...
                                <p className="text-lg md:text-xl text-white/70 leading-relaxed font-light mb-8 max-w-xl mx-auto lg:mx-0">
                                    Ready to define the absolute ceiling of luxury in Winnetka? Merit Homes designs ultra-elite residences that push the boundaries of modern architecture. From lakefront monuments to private estates, we craft the unthinkable.
                                </p>
                                <div
